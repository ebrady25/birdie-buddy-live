...
(() => {
  ...
  const renderAnswers = (d, counts) => {
    ...
    ANS('script', `Blowout ${b.blowout14}% · fav controls ${b.fav_wins - b.blowout14}% · dog wins ${b.dog_wins}% · total: mean actual ${t.mean_actual}, over by 7+ ${t.over7}%, under by 7+ ${t.under7}%${b.n ? ` · <span class="n">n = ${b.n.toLocaleString('en-US')} games at this spread</span>` : ''}`);
